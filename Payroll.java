...
public class Payroll {
	...
	private void initialize() {
		...
		name = new JTextField();
		name.setBounds(177, 115, 86, 20);
		frame.getContentPane().add(name);
		name.setColumns(10);
		
		address = new JTextField();
		address.setBounds(177, 140, 86, 20);
		frame.getContentPane().add(address);
		address.setColumns(10);
		
		code = new JTextField();
		code.setBounds(177, 165, 86, 20);
		...
		textPane.setBounds(786, 87, 293, 225);
		...
		panel.setBounds(355, 69, 221, 177);
		...
		JLabel txttaxcode = new JLabel("Tax Code");
		txttaxcode.setBounds(25, 85, 46, 14);
		panel.add(txttaxcode);
		
		JComboBox comboBox = new JComboBox();
		comboBox.setBounds(114, 50, 85, 20);
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"1", "2", "3", "4", "5"}));
		panel.add(comboBox);
		
		JLabel txttax= new JLabel("Tax Period");
		txttax.setBounds(25, 53, 66, 14);
		panel.add(txttax);
		
		JComboBox comboBox_2 = new JComboBox();
		comboBox_2.setBounds(114, 107, 85, 20);
		comboBox_2.setModel(new DefaultComboBoxModel(new String[] {"A0000", "A000", "A00000"}));
		panel.add(comboBox_2);
		
		JLabel lblNewLabel_4_3 = new JLabel("NI number");
		lblNewLabel_4_3.setBounds(25, 110, 50, 14);
		panel.add(lblNewLabel_4_3);
		
		JComboBox comboBox_1 = new JComboBox();
		comboBox_1.setBounds(114, 82, 85, 20);
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"A", "B", "C"}));
		panel.add(comboBox_1);
		
		textField_14 = new JTextField();
		textField_14.setBounds(113, 138, 86, 20);
		panel.add(textField_14);
		textField_14.setColumns(10);
		
		JLabel lblNewLabel_4_2 = new JLabel("NI code");
		lblNewLabel_4_2.setBounds(25, 143, 46, 14);
		...
		lblNewLabel_5.setBounds(799, 65, 46, 14);
