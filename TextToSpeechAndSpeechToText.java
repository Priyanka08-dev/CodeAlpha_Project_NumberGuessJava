...
public class TextToSpeechAndSpeechToText extends JFrame {
    ...
    public TextToSpeechAndSpeechToText() {
        ...
        speakButton = new JButton("Convert to Speech");
        listenButton = new JButton("Convert to Text");
        ...
        speakButton.setBackground(Color.GREEN);
        listenButton.setBackground(Color.BLUE);
    ...
    private void initializeSpeechRecognition() {
        try {
            RecognizerModeDesc desc = new RecognizerModeDesc(Locale.US, rootPaneCheckingEnabled);
